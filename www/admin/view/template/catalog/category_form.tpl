            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
				  ...
				  <div class="form-group">
					<label class="col-sm-2 control-label" for="input-description-full<?php echo $language['language_id']; ?>"><?php echo $entry_description_full; ?></label>
					<div class="col-sm-10">
					<textarea name="category_description[<?php echo $language['language_id']; ?>][description_full]" placeholder="<?php echo $entry_description_full; ?>" id="input-description-full<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['description_full'] : ''; ?></textarea>
						</div>
						</div>
                  <div class="form-group required">
